...
new \Kirki\Field\Textarea(
    [
        ...
        'default'       => esc_html__( '', 'bootstrap2wordpress' ),
    ]
);
...
new \Kirki\Field\Textarea(
    [
        ...
        'default'           => esc_html__( 'Copyright Henry DelGlitch'),
...
new \Kirki\Section (
    ...
    [
        ...
        'description'       => esc_html__( 'This is the Call to Action Card, in the Pre-Footer Section', 
        'bootstrap2wordpress' ),
        'panel'             => 'b2w_theme_option_panel',
        'priority'          => 160,
    ]
...
new \Kirki\Field\Checkbox_Switch(
    [
        ...
        'description'       => esc_html__( 'Toggle this section on or off.', 
        'bootstrap2wordpress' ),
...
new \Kirki\Field\Textarea(
    [
        ...
        'section'           => 'footer_calltoaction_section',
        'default'           => esc_html__( 'Learn how to design and build custom, beautiful & responsive WordPress
        websites and themes for beginners in 2022', 'bootstrap2wordpress'),
        'partial_refresh'   => array(
